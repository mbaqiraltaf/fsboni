...
class FsProperty extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('prp_add, created_date, updated_date, youtube, fireplace_details, building_name, sub_division, pet_friendly,new_prop_type', 'safe'),
    ...
    public function relations() {
        ...
        return array(
            'fsAdditionalRoomsRelations' => array(self::HAS_MANY, 'FsAdditionalRoomsRelation', 'prop_id', 'together' => false),
            'fsAmenitiesRelations' => array(self::HAS_MANY, 'FsAmenitiesRelation', 'prop_id', 'together' => false),
            'fsAssessnicRelations' => array(self::HAS_MANY, 'FsAssessincRelation', 'prop_id', 'together' => false),
            'fsKitchenRelations' => array(self::HAS_MANY, 'FsKitchenRelation', 'prop_id', 'together' => false),
            'fsAppliancesRelations' => array(self::HAS_MANY, 'FsAppliancesRelation', 'prop_id', 'together' => false),
            'fsAsmtInclRelations' => array(self::HAS_MANY, 'FsAsmtInclRelation', 'prop_id', 'together' => false),
            'fsBathroomAmenitiesRelations' => array(self::HAS_MANY, 'FsBathroomAmenitiesRelation', 'prop_id', 'together' => false),
            'fsEquipmentRelations' => array(self::HAS_MANY, 'FsEquipmentRelation', 'prop_id', 'together' => false),
            'fsExposureRelations' => array(self::HAS_MANY, 'FsExposureRelation', 'prop_id', 'together' => false),
