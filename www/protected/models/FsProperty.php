...
class FsProperty extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('state, city, county, zip_code, price_range, prop_type, prop_style, numbr_bedroom,numbr_bathroom, prop_size, prp_desc,  street_number, street_name', 'required'),
