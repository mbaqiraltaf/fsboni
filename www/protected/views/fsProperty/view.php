...
$this->menu=array(
	...
	array('label'=>'Update FsProperty', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete FsProperty', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage FsProperty', 'url'=>array('admin')),
);
?>

<h1>View FsProperty #<?php echo $model->id; ?></h1>
