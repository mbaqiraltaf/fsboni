...
?>
                            ...
                            <div class="city_row">
                                ...
                                <div class="search_float_box mr0">
                                    <?php echo $form->labelEx($model, 'price_range_min'); ?><br/>
                                    <?php echo $form->dropDownList($model, 'price_range_min', CHtml::listData(FsPriceRange::model()->findAll(), 'VALUE', 'title'), array('prompt' => '')); ?>
                                    <span class="mlr10">to</span>
                                </div>
                                <div class="search_float_box">
                                    <?php echo $form->labelEx($model, 'price_range_max'); ?><br/>
                                    <?php echo $form->dropDownList($model, 'price_range_max', CHtml::listData(FsPriceRange::model()->findAll(), 'VALUE', 'title'), array('prompt' => '')); ?>
