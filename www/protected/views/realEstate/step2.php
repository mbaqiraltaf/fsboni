...
<div class="form">
    ...
    <div class="contact_row">
        ...
        <div class="right_area1 w100">
            <?php
            echo $form->dropDownList($model, 'numbr_bedroom', CHtml::listData(FsNoBedroom::model()->findAll(), 'title', 'title'), array('prompt' => '', 'class' => 'w50')); ?>
        </div>
        ...
        <div style="width:80px;" class="right_area1">
            <?php
            echo $form->dropDownList($model, 'numbr_bathroom', CHtml::listData(FsNoBathroom::model()->findAll(), 'title', 'title'), array('prompt' => '', 'class' => 'w50')); ?>
        </div>
